...
# Title: Ejemplo Calculo Potencia
...
class ejemplo_calculo_potencia(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Ejemplo Calculo Potencia", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Ejemplo Calculo Potencia")
        ...
        self.settings = Qt.QSettings("GNU Radio", "ejemplo_calculo_potencia")
...
def main(top_block_cls=ejemplo_calculo_potencia, options=None):
