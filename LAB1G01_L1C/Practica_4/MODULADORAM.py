...
from moduladorAMV2 import moduladorAMV2  # grc-generated hier_block
...
class MODULADORAM(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Blocks
        ##################################################
        self._ka_range = Range(0, 4, 10e-3, 1, 200)
        ...
        self._fc_range = Range(50, 2200, 100e-3, 50, 200)
        self._fc_win = RangeWidget(self._fc_range, self.set_fc, "frecuencia portadora {MHz}", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self._Ac_range = Range(0, 4, 10e-3, 100e-3, 200)
        ...
        self._A_range = Range(0, 4, 10e-3, 1, 200)
        self._A_win = RangeWidget(self._A_range, self.set_A, "Amplitud mensaje", "counter_slider", float, QtCore.Qt.Horizontal)
        ...
        self.moduladorAMV2_0 = moduladorAMV2(
            Ac=Ac,
            ka=ka,
        )
        ...
        # Connections
        ##################################################
        self.connect((self.analog_sig_source_x_0, 0), (self.moduladorAMV2_0, 0))
        self.connect((self.moduladorAMV2_0, 0), (self.qtgui_freq_sink_x_0, 0))
        self.connect((self.moduladorAMV2_0, 0), (self.qtgui_time_sink_x_0, 0))
        self.connect((self.moduladorAMV2_0, 0), (self.uhd_usrp_sink_0, 0))
    ...
    def set_ka(self, ka):
        self.ka = ka
        self.moduladorAMV2_0.set_ka(self.ka)
    ...
    def set_Ac(self, Ac):
        self.Ac = Ac
        self.moduladorAMV2_0.set_Ac(self.Ac)
